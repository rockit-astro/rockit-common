...
halfmetre_roomalert = PyroDaemon('halfmetre_roomalert_daemon', IP.GOTOServer, 9023, 5)
halfmetre_roofbattery = PyroDaemon('halfmetre_roofbattery_daemon', IP.GOTOServer, 9024, 5)
halfmetre_aircon = PyroDaemon('halfmetre_aircon_daemon', IP.GOTOServer, 9030, 5)
halfmetre_roof = PyroDaemon('halfmetre_roof_daemon', IP.GOTOServer, 9004, 5)
halfmetre_power = PyroDaemon('halfmetre_power_daemon', IP.GOTOServer, 9027, 5)
...
onemetre_blue_camera = PyroDaemon('onemetre_camera_blue', IP.OneMetreBlueCamera, 9011, 5)
onemetre_red_camera = PyroDaemon('onemetre_camera_red', IP.OneMetreRedCamera, 9010, 5)
...
clasp_camera_1 = PyroDaemon('clasp_camera_daemon_1', IP.CLASPDAS1, 9037, 5)
