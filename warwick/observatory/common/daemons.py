...
goto_dome2_sht35 = PyroDaemon('goto_dome2_sht35_daemon', IP.GOTODome2Pi, 9020, 5)
...
superwasp_cam2 = PyroDaemon('superwasp_camera_daemon_2', IP.SWASPCameraPi1, 9041, 5)
superwasp_cam3 = PyroDaemon('superwasp_camera_daemon_3', IP.SWASPCameraPi2, 9042, 5)
superwasp_cam4 = PyroDaemon('superwasp_camera_daemon_4', IP.SWASPCameraPi2, 9043, 5)
