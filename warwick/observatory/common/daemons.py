...
goto_gtecs_mnt = PyroDaemon('mnt', IP.GOTORackRight, 9001, 5)
goto_gtecs_filt = PyroDaemon('filt', IP.GOTORackRight, 9002, 5)
goto_gtecs_foc = PyroDaemon('foc', IP.GOTORackRight, 9003, 5)
