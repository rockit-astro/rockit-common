...
onemetre_blue_camera = PyroDaemon('onemetre_camera_blue', IP.OneMetreCameras, 9011, 5)
onemetre_red_camera = PyroDaemon('onemetre_camera_red', IP.OneMetreCameras, 9010, 5)
