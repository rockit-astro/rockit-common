...
superwasp_pipeline_cam1 = PyroDaemon('superwasp_pipeline_cam1', IP.SWASPDAS1, 9033)
superwasp_cam2 = PyroDaemon('superwasp_camera_daemon_2', IP.SWASPCameraVM2, 9041)
superwasp_pipeline_cam2 = PyroDaemon('superwasp_pipeline_cam2', IP.SWASPDAS1, 9034)
superwasp_cam3 = PyroDaemon('superwasp_camera_daemon_3', IP.SWASPCameraVM3, 9042)
superwasp_pipeline_cam3 = PyroDaemon('superwasp_pipeline_cam3', IP.SWASPDAS2, 9035)
superwasp_cam4 = PyroDaemon('superwasp_camera_daemon_4', IP.SWASPCameraVM4, 9043)
superwasp_pipeline_cam4 = PyroDaemon('superwasp_pipeline_cam4', IP.SWASPDAS2, 9036)
