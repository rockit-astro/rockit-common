...
clasp_pipeline_cam1 = PyroDaemon('clasp_pipeline_daemon_cam1', IP.CLASPTCS, 9033, 5)
clasp_pipeline_cam2 = PyroDaemon('clasp_pipeline_daemon_cam2', IP.CLASPDAS, 9034, 5)
clasp_diskspace_cam1 = PyroDaemon('clasp_diskspace_daemon_cam1', IP.CLASPTCS, 9039, 5)
clasp_diskspace_cam2 = PyroDaemon('clasp_diskspace_daemon_cam2', IP.CLASPDAS, 9039, 5)
