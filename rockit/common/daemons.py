...
superwasp_cam1 = PyroDaemon('superwasp_camera_daemon_1', IP.SWASPCameraVM1, 9040, 5)
superwasp_pipeline_cam1 = PyroDaemon('superwasp_pipeline_cam1', IP.SWASPDAS1, 9033, 5)
superwasp_cam2 = PyroDaemon('superwasp_camera_daemon_2', IP.SWASPCameraVM2, 9041, 5)
superwasp_pipeline_cam2 = PyroDaemon('superwasp_pipeline_cam2', IP.SWASPDAS1, 9034, 5)
superwasp_cam3 = PyroDaemon('superwasp_camera_daemon_3', IP.SWASPCameraVM3, 9042, 5)
superwasp_pipeline_cam3 = PyroDaemon('superwasp_pipeline_cam3', IP.SWASPDAS2, 9035, 5)
superwasp_cam4 = PyroDaemon('superwasp_camera_daemon_4', IP.SWASPCameraVM4, 9043, 5)
superwasp_pipeline_cam4 = PyroDaemon('superwasp_pipeline_cam4', IP.SWASPDAS2, 9036, 5)
superwasp_diskspace_das1 = PyroDaemon('superwasp_diskspace_das1', IP.SWASPDAS1, 9008, 5)
superwasp_diskspace_das2 = PyroDaemon('superwasp_diskspace_das2', IP.SWASPDAS2, 9009, 5)

superwasp_swreduce_1 = PyroDaemon('superwasp_swreduce_1', IP.SWASPDAS1, 9050, 5)
superwasp_swreduce_2 = PyroDaemon('superwasp_swreduce_2', IP.SWASPDAS2, 9050, 5)
...
halfmetre_vaisala = PyroDaemon('halfmetre_vaisala_daemon', IP.CLASPDAS, 9020, 5)
halfmetre_cloudwatcher = PyroDaemon('halfmetre_cloudwatcher_daemon', IP.CLASPDAS, 9021, 5)
...
clasp_camera_1 = PyroDaemon('clasp_camera_daemon_1', IP.CLASPCMOSVM, 9037, 5)
clasp_camera_2 = PyroDaemon('clasp_camera_daemon_2', IP.CLASPSWIRVM, 9038, 5)
clasp_pipeline_cam1 = PyroDaemon('clasp_pipeline_daemon_cam1', IP.CLASPDAS, 9031, 5)
clasp_pipeline_cam2 = PyroDaemon('clasp_pipeline_daemon_cam2', IP.CLASPTCS, 9031, 5)
clasp_diskspace_cam1 = PyroDaemon('clasp_diskspace_daemon_cam1', IP.CLASPDAS, 9039, 5)
clasp_diskspace_cam2 = PyroDaemon('clasp_diskspace_daemon_cam2', IP.CLASPTCS, 9039, 5)
...
clasp_chiller = PyroDaemon('clasp_chiller_daemon', IP.CLASPTCS, 9042, 5)
